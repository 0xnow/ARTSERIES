...
contract ARTS is ERC20, ERC20Multisend, Privileged, TokenRetriever {
    // Privileges
    uint8 constant PRIV_ROOT = 1;

    constructor() public ERC20("ARTSTOKEN", "ARTS", 0) Privileged(PRIV_ROOT) TokenRetriever(PRIV_ROOT) {
    }
